...
const LogoutModal = (props) => {
  const { isVisible, onCloseLogout } = props;
  ...
  return (
    <Modal isVisible={isVisible} style={{ margin: 0 }} backdropOpacity={0.25}>
      <Container>
        <Warning />
        <Explain>로그아웃 하시겠습니까?</Explain>
        <Buttons>
          <Button onPress={onPressCancel}>
            <ButtonText>취소</ButtonText>
          </Button>
          <Button style={{ backgroundColor: colors.primary, borderColor: colors.primary }} onPress={onPressLogoutModal}>
